...
![LexiGuard AI Pipeline Demo](docs/images/pipeline_demo.gif)

*Subtle, purposeful visual validations prove the operational readiness of the underlying FastAPI and Celery worker infrastructure.*
